...
public class ClientappApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * 
		 * // Instanciar um objeto da classe Curso
		 * Curso curso2 = new Curso("Ingles", "Segundo curso cadastrado - TESTE", 50,
		 * 10, Instant.parse("2024-01-01T07:00:00.00Z"),
		 * Instant.parse("2024-06-01T07:00:00.00Z"), "Ativo");
		 ...
		 * System.out.println("******Início da Lista******");
		 * System.out.
		 * println("******Cursos com numero de vagas maior ou igual a 20******");
		 ...
		 * 
		 * cursos =
		 * repositorio.findByDataInicioAfter(Instant.parse("2024-07-01T07:00:00.00Z"));
		 * System.out.println("******Início da Lista******");
		 ...
		 * 
		 * 
		 * //(Long id, String nome, String cpf, String email, String senha, Instant
		 * nascimento, String endereco, String status)
		 * Usuario u = new Usuario(null, "Caio Passos da Silva", "11111111111",
		 * "Professor", "email", "senha", Instant.now(), "endereco", "x");
