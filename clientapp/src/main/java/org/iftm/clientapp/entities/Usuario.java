...
public class Usuario implements Serializable {
    ...
    public Usuario(Long id, String nome, String cpf, String tipo, String email, String senha, Instant nascimento, String endereco, String status, Matricula matricula) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.tipo = tipo;
